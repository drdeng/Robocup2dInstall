...
QT_MOC_LITERAL(3, 24, 5), // "shown"
QT_MOC_LITERAL(4, 30, 2), // "on"
QT_MOC_LITERAL(5, 33, 22), // "validateBallCoordinate"
QT_MOC_LITERAL(6, 56, 12), // "resetChanges"
QT_MOC_LITERAL(7, 69, 12), // "applyToField"
QT_MOC_LITERAL(8, 82, 10) // "updateData"

    },
    "EditDialog\0viewUpdated\0\0shown\0on\0"
    "validateBallCoordinate\0resetChanges\0"
    "applyToField\0updateData"
};
...
void EditDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditDialog::viewUpdated)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (EditDialog::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditDialog::shown)) {
                *result = 1;
                return;
            }
        }
