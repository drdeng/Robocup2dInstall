...
QT_MOC_LITERAL(4, 32, 13), // "handleReceive"
QT_MOC_LITERAL(5, 46, 11) // "handleTimer"

    },
    "MonitorClient\0received\0\0timeout\0"
    "handleReceive\0handleTimer"
};
...
void MonitorClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MonitorClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MonitorClient::timeout)) {
                *result = 1;
                return;
            }
        }
